...
describe("Dialog", () => {
  ...
  describe("event listeners", () => {
    ...
    it("binds the key event listener to the document on mount", () => {
      ...
      expect(addElementResizeSpy).toHaveBeenCalledTimes(2);
    });
    ...
    it("removes the event listener if modal was open on unmount", () => {
      ...
      expect(removeElementResizeSpy).toHaveBeenCalledTimes(2);
    });
  ...
  describe("fixed bottom", () => {
    ...
    describe("when it should have a fixed bottom", () => {
      it("sets appliedFixedBottom to true", () => {
        Object.defineProperty(
          wrapper.find(DialogInnerContentStyle).getDOMNode(),
          "offsetHeight",
          {
            configurable: true,
            value: 100,
        ...
        wrapper.update();
        expect(wrapper.find(DialogStyle).props().fixedBottom).toBe(true);
      });
    });

    describe("when it should not have a fixed bottom", () => {
      it("sets appliedFixedBottom to false", () => {
        Object.defineProperty(
          wrapper.find(DialogInnerContentStyle).getDOMNode(),
          "offsetHeight",
          {
        ...
        wrapper.update();
        expect(wrapper.find(DialogStyle).props().fixedBottom).toBe(false);
      });
    });
  });
  ...
  describe("when fixedBottom is passed to the DialogStyle", () => {
    it("should add the correct styles to DialogStyle", () => {
      assertStyleMatch(
        ...
        mount(<DialogStyle open fixedBottom />)
      );
    });
  });
  ...
  describe("when fixedBottom is passed to the DialogContentStyle", () => {
    it("should render matched snpashot", () => {
      assertStyleMatch(
        ...
        mount(<DialogContentStyle fixedBottom />)
      );
    });
  });
